...
\begin{minipage}{.50\textwidth}
  ...
  \captionof{figure}{Do's and Don'ts (bron: \href{https://dcdark.net/2016-hhv-kit/index.html}{DefCon}).}\label{fig:1}
\end{minipage}
\begin{minipage}{.50\textwidth}
  \includegraphics[width=\textwidth]{images/correct_joint.png}
  \captionof{figure}{Correcte / Incorrecte joints (bron: \href{https://dcdark.net/2016-hhv-kit/index.html}{DefCon}).}\label{fig:2}
\end{minipage}
...
\end{minipage}\quad\begin{minipage}{.40\textwidth}
  ...
  \captionof{figure}{De hotspot (bron: \href{https://dcdark.net/2016-hhv-kit/index.html}{DefCon}).}\label{wrap-fig:1}
\end{minipage}
